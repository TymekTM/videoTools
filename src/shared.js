...
function loadExportCss() {
  ...
  var dir = __dirname;
  var files = ['base.css', 'newspaper.css', 'chat.css', 'typing.css', 'map.css', 'chart.css', 'calendar.css', 'notification.css', 'corridorkey.css', 'subtitles.css', 'webcap.css', 'character.css'];
  var parts = [];
